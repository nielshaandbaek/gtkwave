...
static void enter_callback_e(GtkWidget *widget, GtkWidget *nothing)
{
  ...
  if (!(len = strlen(entry_text)))
    ...
    strcpy((GLOBALS->entrybox_text_local_hiersearch_c_1 = (char *)malloc_2(len + 1)), entry_text);
...
static void ok_callback(GtkWidget *widget, GtkWidget *nothing)
{
  ...
  if ((!GLOBALS->h_selectedtree_hiersearch_c_1) || (!GLOBALS->h_selectedtree_hiersearch_c_1->child))
    return;
